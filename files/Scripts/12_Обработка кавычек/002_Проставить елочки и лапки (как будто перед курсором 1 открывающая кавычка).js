...
function Run() {
 ...
 var versionStr="Скрипт «Проставить елочки и лапки v3.0 (начиная с 1-го уровня)»\nАвтор Sclex.\n\n";
 var otstupSverhu=60;
 var debug=false;
  ...
  while (el!=selectionEndEl && el!=fbw_body) {
   ...
   if (el.hasChildNodes()) {
    ...
    if (el.nodeName=="DIV") {
     ...
     blockInitQuotesLevel[currentBlockIndex]=0;
