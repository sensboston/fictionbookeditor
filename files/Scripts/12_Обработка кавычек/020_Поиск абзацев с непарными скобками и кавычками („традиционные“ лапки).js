...
function Run() {
 ...
 function searchNext() {
  ...
  // -----------------------------------------------------------------------------------------------------------------------
   ...
   // удалить всё кроме указанных скобок и кавычек + перечни типа 1), 2), 3), а), б), в) с начала строки:
   ...
   if (!s) {
      ...
      desc = "Найдено: Следующие символы непарные: "+ s+".          Вы выбрали проверку документа с „традиционными“ лапками (н99…в66).";
   }
