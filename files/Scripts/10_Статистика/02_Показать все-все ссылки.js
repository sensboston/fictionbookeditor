...
{
 var MsgWindow = window.open("HTML/Показать все-все ссылки.html",null,"height=710,width=300,status=no,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
