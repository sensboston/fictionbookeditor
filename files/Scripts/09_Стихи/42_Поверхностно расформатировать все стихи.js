...
//    Скрипт предназначен для исправления одной редкой ошибки в файле FB2, при которой весь текст книги хаотично и бессистемно отформатирован как «стихи».
...
function Run() {
 var ScriptName="«Поверхностное расформатирование всех стихов»";
...
// -----------------------------
 ...
 if (!AskYesNo("						          \n"+
                              "     Скрипт предназначен для исправления\n"+
                              "одной редкой ошибки, при которой текст книги\n"+
                              "хаотично и бессистемно отформатирован как «стихи».\n\n"+
                              "     Для исправления этой ошибки, скрипт...\n"+
                              "добавляет пустые строки на стыке «строф» (<stanza>);\n"+
                              "удаляет почти всё форматирование «стих» (<poem>);\n"+
                              "удаляет почти всё форматирование «строфа» (<stanza>);\n"+
                              "и изменяет почти все теги <v> на <p>.\n\n"+
                              "     Все другие форматы сохраняются.\n\n"+
                              "                                ПРОДОЛЖИТЬ ?  "))
         return;
...
// -----------------------------
 ...
 var ind=0;
                 ...
                 mSt[ind]=" «Поверхностное";  ind++;
                 mSt[ind]="         расформатирование  всех стихов» v."+NumerusVersion;  ind++;
                 mSt[ind]="--------------------------------------------------------------";  ind++;
 ...
 if (count_101!=d) { mSt[ind]="Вставка пустых строк на стыке строф .  .  .  .	"+count_101;  ind++ }
 if (count_111!=d) { mSt[ind]="Удаление формата строф (\"stanza\")  .  .  .  .  .	"+count_111;  ind++ }
 if (count_112!=d) { mSt[ind]="Удаление формата стихов (\"poem\")   .  .  .  .  .	"+count_112;  ind++ }
...
// v.1.4 — Исправлены все ошибки в окнах для win7   — Александр Ка (18.01.2025)
