// «Создать заголовки стихов из строк-звёздочек v.1.0» для редактора Fiction Book Editor (FBE).
// Версия 1.11.
// Автор stokber.
//
function Run() {
	var name = "Создать заголовки стихов из строк-звёздочек";
	var version = 1.11;
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	counterBefore();
	window.external.BeginUndoUnit(document, name);
	zamena();
	correction();
