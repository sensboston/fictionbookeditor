// «Создать (под)заголовки из первых строк стихов, ориентируясь по абзацам-звездочкам...» для редактора Fiction Book Editor (FBE).
// Версия 1.0.
// Автор stokber.
//
function Run() {
	var name = "Создать (под)заголовки из первых строк стихов, ориентируясь по абзацам-звездочкам...";
	var version = "1.0";
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	counterBefore();
	window.external.BeginUndoUnit(document, "создание (под)заголовков из первых строк стихов");
	zamena();
	correction();
