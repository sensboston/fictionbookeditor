...
// Версия 1.2
// Автор Sclex, набор RegExp-ов - TaKir, Sclex, 21.11.2022
...
// -------------начало блока TaKir - регэкспы (TaKir, 22.11.2024)---------------
  ...
  addRegExp("([A-Za-zА-яЁё0-9…,;.»\"!?:%“™”©\\)])[\[\*]","","Найдено: звездочки или скобки после букв, цифр и знаков препинания");

// addRegExp("[\]\*]([\\x20\\xA0])?[A-Za-zА-яЁё]","","Найдено: звездочки или скобки перед буквами");


  addRegExp("([A-Za-zА-яЁё…,;.»\"!?:%“™”©\\)])([0-9])([0-9])([0-9])([0-9])","","Найдено: 4 цифры, прилипшие к словам");
  addRegExp("([A-Za-zА-яЁё…,;.»\"!?:%“™”©\\)])([0-9])([0-9])([0-9])","","Найдено: 3 цифры, прилипшие к словам");
  addRegExp("([A-Za-zА-яЁё…,;.»\"!?:%“™”©\\)])([0-9])([0-9])","","Найдено: 2 цифры, прилипшие к словам");
  addRegExp("([A-Za-zА-яЁё…,;.»\"!?:%“™”©\\)])([0-9])","","Найдено: 1 цифра, прилипшая к словам");
