...
function Run2() {  // Примечания из скобок.
...
function getVersionStr() {
 return("'Превратить внешние ссылки в примечания' v"+versionNumber+".\n\n");
}
...
function getRandomNum(n) {
 ...
 return s;
    ...
    window.external.BeginUndoUnit(document,"создание примечаний из внешних ссылок");                               // ОТКАТ (UNDO) начало
Run1();
Run2();
    window.external.EndUndoUnit(document);                                             // undo конец
