// Скрипт «Перейти на следующую строфу» (stanza)
...
function Run() {
 ...
 var undoMsg="переход на следующую строфу";
 var statusBarMsg="Переходим на следующую строфу…";
 var notFoundMsg="До конца документа не нашлось ни одной строфы.";
