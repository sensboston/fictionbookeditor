// Скрипт «Перейти на предыдущую аннотацию» (annotation)
// Автор Sclex, сборка TaKir
// Версия 1.1

function Run() {

 var blockElementClass="annotation"; // класс блочного элемента, который (элемент) нужно искать
 var undoMsg="переход на предыдущую аннотацию";
 var statusBarMsg="Переходим на предыдущую аннотацию…";
 var notFoundMsg="До начала документа не нашлось ни одной аннотации.";
 ...
 function checkP(elem1) {
  ...
  if (hasAmongParents(elem1,"annotation")) return true;
  return false;
 }
