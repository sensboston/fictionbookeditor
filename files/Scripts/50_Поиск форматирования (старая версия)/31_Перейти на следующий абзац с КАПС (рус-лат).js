// Скрипт «Перейти на следующий абзац со словами заглавными буквами, "КАПС" (рус-лат)» для редактора Fiction Book Editor (FBE).
// Версия 5.1
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайший абзац со словами заглавными буквами (2 и более букв), "КАПС" (рус-лат) вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("^(.*?)[A-ZА-ЯЁ]{2,}(.*?)$","","Найдено: Абзац со словами заглавными буквами - КАПС.");
