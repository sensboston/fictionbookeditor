// Скрипт «Перейти на следующую кириллицу» для редактора Fiction Book Editor (FBE).
// Версия 5.1
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайшую кириллицу вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("[а-яёА-ЯЁ]{1,}","","Найдено: Слово или буква кириллицей.");
