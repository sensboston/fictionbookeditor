// Скрипт «Перейти на предыдущий стих» (poem)
// Автор Sclex, сборка TaKir
// Версия 1.3

function Run() {

 var blockElementClass="poem"; // класс блочного элемента, который (элемент) нужно искать
 var undoMsg="переход на предыдущий стих";
 var statusBarMsg="Переходим на предыдущий стих…";
 var notFoundMsg="До начала документа не нашлось ни одного стиха.";
 ...
 function checkP(elem1) {
  ...
  if (hasAmongParents(elem1,"poem")) return true;
  return false;
 }
