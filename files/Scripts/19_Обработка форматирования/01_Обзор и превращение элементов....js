...
function Run() {
 var elementBrowser_versionNum="4.1";
 ...
 coll["shortWords"]="им.|без|в|вне|во|для|до|за|из|из-за|из-под|к|ко|на|над|о|об|обо|от|по|под|при|про|с|со|у|а|да|и|или|не|ни|но|б|бы|ж|же|ли|a|an|and|at|but|by|for|from|in|nor|of|on|or|the|to";
