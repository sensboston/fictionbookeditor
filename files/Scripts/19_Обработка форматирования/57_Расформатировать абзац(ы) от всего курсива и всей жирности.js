// Скрипт «Расформатировать абзац(ы) от всего курсива и всей жирности»
// Автор Sclex
// Версия 1.5

function Run() {

 var undoMsg="расформатирование абзаца(-ев) от всего курсива и всей жирности";
 var statusBarMsg="Расформатируем абзац(ы) от всего курсива и всей жирности…";
 //имя тэга, который будет использован для маркеров начала и конца выделения
 var markerTagName="STRIKE";

 function processPs() {
  for (var i=0; i<ps.length; i++)
   ps[i].innerHTML=ps[i].innerHTML.replace(/<\/?(EM|I|STRONG|B)( [^>]*)?>/gi,"");
 }
