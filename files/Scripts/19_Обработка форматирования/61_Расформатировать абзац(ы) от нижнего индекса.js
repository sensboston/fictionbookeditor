// Скрипт «Сформатировать абзац(ы) от нижнего индекса»
// Автор Sclex
// Версия 1.5

function Run() {

 var undoMsg="расформатирование абзаца(-ев) от нижнего индекса";
 var statusBarMsg="Расформатируем абзац(ы) от нижнего индекса…";
