// Скрипт «Сформатировать абзац(ы) жирностью»
// Автор Sclex
// Версия 1.5

function Run() {

 var undoMsg="форматирование абзаца(-ев) жирностью";
 var statusBarMsg="Форматируем абзац(ы) жирностью…";
 //имя тэга, который будет использован для маркеров начала и конца выделения
 var markerTagName="I";

 function processPs() {
  for (var i=0; i<ps.length; i++)
   ps[i].innerHTML="<STRONG>"+ps[i].innerHTML.replace(/<\/?(B|STRONG)( [^>]*)?>/gi,"")+"</STRONG>";
 }
