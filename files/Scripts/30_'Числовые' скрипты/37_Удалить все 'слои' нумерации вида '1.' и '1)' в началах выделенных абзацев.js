//скрипт «Удалить все 'слои' нумерации вида "1." и "1)" в началах выделенных абзацев»
//автор Sclex
//v1.2
...
//     alert("Будем заменять вот на что:\n\n"+pInnerHTML);
 ...
 window.external.BeginUndoUnit(document,"удаление всех 'слоев' нумерации вида '1.' и '1)' в началах выделенных абзацев");
 try { window.external.SetStatusBarText("Удаляем все 'слои' нумерации вида '1.' и '1)' в началах выделенных абзацев..."); }
 catch(e) {}
