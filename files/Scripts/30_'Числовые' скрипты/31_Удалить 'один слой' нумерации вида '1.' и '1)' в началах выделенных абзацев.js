//скрипт «Удалить 'один слой' нумерации вида "1." и "1)" в началах выделенных абзацев»
//автор Sclex
//v1.2
...
//     alert("Будем заменять вот на что:\n\n"+pInnerHTML);
 ...
 window.external.BeginUndoUnit(document,"удаление 'одного слоя' нумерации вида '1.' и '1)' в началах выделенных абзацев");
 try { window.external.SetStatusBarText("Удаляем 'один слой' нумерации вида '1.' и '1)' в началах выделенных абзацев..."); }
 catch(e) {}
