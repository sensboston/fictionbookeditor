// Скрипт "По очереди расформатировать все стихи от жирности и курсива" (пошаговый вариант)
// Версия 1.5
// Автор Sclex
...
function Run() {
 window.RunSubscripts=function() {
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     runScriptInFolder("\\16_Поиск форматирования\\54_Перейти на следующий стих (poem).js"); {
     runScriptInFolder("\\19_Обработка форматирования\\55_Расформатировать абзац(ы) от жирности.js");
