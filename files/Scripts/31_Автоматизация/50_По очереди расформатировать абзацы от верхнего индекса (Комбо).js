// Скрипт "По очереди расформатировать абзацы от верхнего индекса" (пошаговый вариант)
...
function Run() {
 window.RunSubscripts=function() {
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     runScriptInFolder("16_Поиск форматирования\\12_Перейти на следующий абзац с верхним индексом.js"); {
