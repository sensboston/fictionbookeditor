// Скрипт "Расформатировать все абзацы от верхнего индекса" (множественный автомат)
// Основан на скрипте "Запуск скриптов по списку"
// Версия 1.5
// Автор Sclex
...
//    runScriptInFolder("\\19_Обработка форматирования\\41_Сформатировать абзац(ы) курсивом.js");
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     while (runScriptInFolder("16_Поиск форматирования\\12_Перейти на следующий абзац с верхним индексом.js")=="Found") {
     runScriptInFolder("\\19_Обработка форматирования\\60_Расформатировать абзац(ы) от верхнего индекса.js");
