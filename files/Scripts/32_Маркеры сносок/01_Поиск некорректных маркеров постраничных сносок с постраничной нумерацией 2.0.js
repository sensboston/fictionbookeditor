...
// постраничных сносок с постраничной нумерацией;
// поглавных сносок с поглавной нумерацией;
...
function Report() {
   ...
   // txt = txt.replace(/☻([ ]*)☺/g, "$1"); // два маркера подряд или только с пробелами между считать за один ошибочный.13.09.2023  !?!?!?!?
