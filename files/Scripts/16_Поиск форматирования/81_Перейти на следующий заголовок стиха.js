// Скрипт «Перейти на следующий заголовок стиха» (title внтури poem)
...
function Run() {
 ...
 var undoMsg="переход на следующий заголовок стиха";
 var statusBarMsg="Переходим на следующий заголовок стиха…";
 var notFoundMsg="До конца документа не нашлось ни одного заголовка стиха.";
