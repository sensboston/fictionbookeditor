// Скрипт «Переход на следующий нетекстовый подзаголовок (звездочки, решетки и пр.)» для редактора Fiction Book Editor (FBE).
// Версия 1.2
// Автор Sclex.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("[\*]\\s?[\*]\\s?[\*]","","Найдено: Нетекстовый подзаголовок из звездочек","+subtitle");
  addRegExp("#\\s?#\\s?#","","Найдено: Нетекстовый подзаголовок из решеток","+subtitle");

  addRegExp("[*][\\x20\\xA0]*[*][\\x20\\xA0]*[*]","","Найдено: Нетекстовый подзаголовок из звездочек с разными пробелами","+subtitle");
  addRegExp("[#][\\x20\\xA0]*[#][\\x20\\xA0]*[#]","","Найдено: Нетекстовый подзаголовок из решеток с разными пробелами","+subtitle");
