// Скрипт «Выделить предыдущий целиком курсивный и жирный абзац»
// Автор Sclex
// Версия 1.2

function Run() {

 var undoMsg="переход на предыдущий целиком курсивный и жирный абзац";
 var statusBarMsg="Переходим на предыдущий целиком курсивный и жирный абзац…";
 var notFoundMsg="До начала документа не нашлось ни одного целиком курсивного и жирного абзаца.";
