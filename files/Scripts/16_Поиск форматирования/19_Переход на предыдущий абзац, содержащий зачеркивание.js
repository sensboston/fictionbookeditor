...
function Run() {
 var versionStr="Переход на предыдущий абзац, содержащий зачеркивание v1.0.";
 var scriptDirection="backward";
 var isItTagWeLookingFor=function (t) { if (t.nodeName=="STRIKE") return true; else return false;}
