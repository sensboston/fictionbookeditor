// Скрипт «Перейти на следующий абзац с кириллицей» для редактора Fiction Book Editor (FBE).
// Версия 5.0
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайший абзац с кириллицей вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("^(.*?)[а-яёА-ЯЁ]{1,}(.*?)$","","Найдено: Абзац с кириллицей.");
