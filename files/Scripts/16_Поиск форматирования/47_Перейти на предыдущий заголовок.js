// Скрипт «Перейти на предыдущий заголовок» (title)
...
function Run() {
 ...
 var undoMsg="переход на предыдущий заголовок";
 var statusBarMsg="Переходим на предыдущий заголовок…";
 var notFoundMsg="До начала документа не нашлось ни одного заголовка.";
