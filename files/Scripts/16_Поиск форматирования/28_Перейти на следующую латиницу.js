// Скрипт «Перейти на следующую латиницу» для редактора Fiction Book Editor (FBE).
// Версия 5.0
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайшую латиницу вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("[a-zA-Z]{1,}","","Найдено: Слово или буква латиницей.");
