// Скрипт «Перейти на следующую ссылку» для редактора Fiction Book Editor (FBE).
// Версия 5.1
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайшую ссылку вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("(ftp.*|mail.*|.*@.*|file.*|www.*|http.*|https.*)","i","Найдено: Ссылка");
