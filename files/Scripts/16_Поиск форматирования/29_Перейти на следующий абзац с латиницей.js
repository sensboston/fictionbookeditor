// Скрипт «Перейти на следующий абзац с латиницей» для редактора Fiction Book Editor (FBE).
// Версия 5.0
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайший абзац с латиницей вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("^(.*?)[a-zA-Z]{1,}(.*?)$","","Найдено: Абзац с латиницей.");
