// Скрипт «Переход на следующий текстовый подзаголовок» для редактора Fiction Book Editor (FBE).
// Версия 1.2
// Автор Sclex.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("[A-Za-zА-яЁё|0-9](.*)","","Найдено: Текстовый подзаголовок","+subtitle");
