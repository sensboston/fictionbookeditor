// Скрипт «Переход на следующую пустую строку» для редактора Fiction Book Editor (FBE).
// Версия 2.9 (СТАРАЯ, используется для корректной работы с пустыми строками)
// Автор Sclex.
...
// костыль для снятия «ступора» курсора на стыках с DIV-ами.
