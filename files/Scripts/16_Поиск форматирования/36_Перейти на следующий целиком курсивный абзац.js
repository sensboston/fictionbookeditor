// Скрипт «Перейти на следующий целиком курсивный абзац»
// Автор Sclex
// Версия 1.1

function Run() {

 var undoMsg="переход на следующий целиком курсивный абзац";
 var statusBarMsg="Переходим на следующий целиком курсивный абзац…";
 var notFoundMsg="До конца документа не нашлось ни одного целиком курсивного абзаца.";
