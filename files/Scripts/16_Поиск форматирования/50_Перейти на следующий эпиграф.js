// Скрипт «Перейти на следующий эпиграф» (epigraph)
...
function Run() {
 ...
 var undoMsg="переход на следующий эпиграф";
 var statusBarMsg="Переходим на следующий эпиграф…";
 var notFoundMsg="До конца документа не нашлось ни одного эпиграфа.";
