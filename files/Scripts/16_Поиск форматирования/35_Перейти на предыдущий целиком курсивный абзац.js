// Скрипт «Перейти на предыдущий целиком курсивный абзац»
// Автор Sclex
// Версия 1.1

function Run() {

 var undoMsg="переход на предыдущий целиком курсивный абзац";
 var statusBarMsg="Переходим на предыдущий целиком курсивный абзац…";
 var notFoundMsg="До начала документа не нашлось ни одного целиком курсивного абзаца.";
