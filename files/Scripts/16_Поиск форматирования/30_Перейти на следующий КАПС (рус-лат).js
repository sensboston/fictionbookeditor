// Скрипт «Перейти на следующее cлово заглавными буквами, "КАПС" (рус-лат)» для редактора Fiction Book Editor (FBE).
// Версия 5.0
// Основано на скрипте "Поиск по набору регэкспов"
// Автор Sclex, сборка TaKir
// Скрипт производит переход на ближайшее cлово (2 и более букв) заглавными буквами, "КАПС" (рус-лат) вниз по тексту.
...
function Run() {
 ...
 function init() {
  ...
  addRegExp("[A-ZА-ЯЁ]{2,}","","Найдено: Слово заглавными буквами - КАПС.");
