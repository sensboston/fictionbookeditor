// Скрипт «Перейти на предыдущую цитату» (cite)
// Автор Sclex, сборка TaKir
// Версия 1.1

function Run() {

 var blockElementClass="cite"; // класс блочного элемента, который (элемент) нужно искать
 var undoMsg="переход на предыдущую цитату";
 var statusBarMsg="Переходим на предыдущую цитату…";
 var notFoundMsg="До начала документа не нашлось ни одной цитаты.";
 ...
 function checkP(elem1) {
  ...
  if (hasAmongParents(elem1,"cite")) return true;
  return false;
 }
