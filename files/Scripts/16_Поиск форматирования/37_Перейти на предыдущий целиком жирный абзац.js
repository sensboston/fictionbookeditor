// Скрипт «Перейти на предыдущий целиком жирный абзац»
// Автор Sclex
// Версия 1.1

function Run() {

 var undoMsg="переход на предыдущий целиком жирный абзац";
 var statusBarMsg="Переходим на предыдущий целиком жирный абзац…";
 var notFoundMsg="До начала документа не нашлось ни одного целиком жирного абзаца.";
