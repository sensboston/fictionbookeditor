// Скрипт «Перейти на следующую цитату» (cite)
...
function Run() {
 ...
 var undoMsg="переход на следующую цитату";
 var statusBarMsg="Переходим на следующую цитату…";
 var notFoundMsg="До конца документа не нашлось ни одной цитаты.";
