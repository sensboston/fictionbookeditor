// Скрипт «Выделить предыдущую таблицу» (table)
...
function Run() {
 ...
 var undoMsg="переход на предыдущую таблицу";
 var statusBarMsg="Переходим на предыдущую таблицу…";
 var notFoundMsg="До начала документа не нашлось ни одной таблицы.";
