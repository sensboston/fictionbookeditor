// Скрипт «Перейти на предыдущий целиком курсивный, но НЕ целиком жирный абзац»
// Автор Sclex
// Версия 1.1

function Run() {

 var undoMsg="переход на предыдущий целиком курсивный, но НЕ целиком жирный абзац";
 var statusBarMsg="Переходим на предыдущий целиком курсивный, но НЕ целиком жирный абзац…";
 var notFoundMsg="До начала документа не нашлось ни одного целиком курсивного, но НЕ целиком жирного абзаца.";
 ...
 while (ptr && fbwBody.contains(ptr)) {
  if (isEntirelyItalic(ptr) && !isEntirelyBold(ptr)) break;
  ptr=getPreviousP(ptr);
 }
