// Скрипт «Перейти на следующий стих» (poem)
...
function Run() {
 ...
 var undoMsg="переход на следующий стих";
 var statusBarMsg="Переходим на следующий стих…";
 var notFoundMsg="До конца документа не нашлось ни одного стиха.";
