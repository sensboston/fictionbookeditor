// Скрипт «Перейти на следующий заголовок» (title)
...
function Run() {
 ...
 var undoMsg="переход на следующий заголовок";
 var statusBarMsg="Переходим на следующий заголовок…";
 var notFoundMsg="До конца документа не нашлось ни одного заголовка.";
