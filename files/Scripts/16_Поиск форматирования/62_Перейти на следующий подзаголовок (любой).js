// Скрипт «Перейти на следующий подзаголовок (любой)» (subtitle)
// Автор Sclex, сборка TaKir
// Версия 1.3

function Run() {

 var undoMsg="переход на следующий подзаголовок (любой)";
 var statusBarMsg="Переходим на любой следующий подзаголовок…";
 var notFoundMsg="До конца документа не нашлось ни одного подзаголовка.";
