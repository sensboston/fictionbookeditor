// Скрипт «Выделить предыдущий заголовок стиха» (title)
...
function Run() {
 ...
 var undoMsg="переход на предыдущий заголовок стиха";
 var statusBarMsg="Переходим на предыдущий заголовок стиха…";
 var notFoundMsg="До начала документа не нашлось ни одного заголовка стиха.";
