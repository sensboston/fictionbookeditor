// Скрипт «Выделить предыдущий подзаголовок (любой)» (subtitle) 
// Автор Sclex, сборка TaKir
// Версия 1.4

function Run() {

 var undoMsg="переход на предыдущий подзаголовок (любой)";
 var statusBarMsg="Переходим на любой предыдущий подзаголовок…";
 var notFoundMsg="До начала документа не нашлось ни одного подзаголовка.";
 try { var nbspChar=window.external.GetNBSP(); var nbspEntity; if (nbspChar.charCodeAt(0)==160) nbspEntity="&nbsp;"; else nbspEntity=nbspChar; }
 catch(e) { var nbspChar=String.fromCharCode(160); var nbspEntity="&nbsp;";};
 var subtitleRegExp=new RegExp("^.*");
