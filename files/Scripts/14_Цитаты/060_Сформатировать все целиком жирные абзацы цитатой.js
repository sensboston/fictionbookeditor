// Скрипт "Сформатировать все целиком жирные абзацы цитатой" (множественный автомат)
// Версия 1.5
// Автор Sclex
...
//    runScriptInFolder("\\19_Обработка форматирования\\41_Сформатировать абзац(ы) курсивом.js");
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     while (runScriptInFolder("16_Поиск форматирования\\138_Выделить следующий целиком жирный абзац.js")=="Found") {
