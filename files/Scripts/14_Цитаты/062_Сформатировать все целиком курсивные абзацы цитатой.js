// Скрипт "Сформатировать все целиком курсивные абзацы цитатой" (множественный автомат)
// Версия 1.5
// Автор Sclex
...
function Run() {
 window.RunSubscripts=function() {
   ...
   // scriptsFolder("c:\\program files\\fbe 2.7.4\\scripts");
...
//    runScriptInFolder("\\19_Обработка форматирования\\41_Сформатировать абзац(ы) курсивом.js");
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     runScriptInFolder("\\34_Управление курсором либо выделением\\001_Установить курсор в начало документа.js");
    
     while (runScriptInFolder("16_Поиск форматирования\\136_Выделить следующий целиком курсивный абзац.js")=="Found") {
     runScriptInFolder("\\14_Цитаты\\052_Сформатировать абзац(ы) цитатой.js");
    }
   ...
   // (можно сделать несколько таких строк):
   //runScript("c:\\program files\\fbe 2.7.4\\scripts\\06_Чистка\\03_Латиница в Кириллице.js");
