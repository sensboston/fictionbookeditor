// Скрипт "По очереди сформатировать все целиком жирные абзацы цитатой" (пошаговый вариант)
// Версия 1.5
// Автор Sclex
...
function Run() {
 window.RunSubscripts=function() {
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     runScriptInFolder("\\16_Поиск форматирования\\138_Выделить следующий целиком жирный абзац.js"); {
