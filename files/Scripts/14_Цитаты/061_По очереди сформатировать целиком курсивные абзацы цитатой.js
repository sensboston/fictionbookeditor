// Скрипт "По очереди сформатировать все целиком курсивные абзацы цитатой" (пошаговый вариант)
// Версия 1.5
// Автор Sclex
...
function Run() {
 window.RunSubscripts=function() {
   ...
   // Тут сами пользовательские команды поиска и обработки:
     ...
     runScriptInFolder("\\16_Поиск форматирования\\136_Выделить следующий целиком курсивный абзац.js"); {
