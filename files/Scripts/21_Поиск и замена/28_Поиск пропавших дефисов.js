...
// -------------начало блока TaKir - регэкспы (TaKir, 16.05.2024)---------------
  ...
  //  1) Поиск пропущенных дефисов (что-то, где-либо, юго-запад и подобные)
  //  _._._._._._._._._._._._._._._._._._._._._._._._
  ...
  addRegExp("(?<![а-яё])когото(?![а-яё])","i","Найдено: слово \"когото\" (\"кого-то\" без дефиса).");
...
// -------------конец блока TaKir - регэкспы (16.05.2024):---------------
