...
// Версия 5.3
// Автор Sclex, набор RegExp-ов - TaKir, Sclex, октябрь, 2025
...
// Укороченный поиск только «подозрительных символов».
// Лучше выполнять после выполнения скриптов «Генеральная уборка» и «Расстановка ёлочек и лапок».
// Тогда будет гораздо меньше ложных срабатываний.

//  _________________________________________________________________________

  // Скрипту можно назначить горячую клавишу F2 (меню: Сервис-Настройки-Клавиши-Скрипты-Поиск по набору регэкспов,
...
// -------------начало блока TaKir - регэкспы (25.10.2025)---------------
  ...
  addRegExp("(а́|е́|ё́|и́|о́|у́|ы́|э́|ю́|я́|А́|Е́|И́|О́|У́|Ы́|Э́|Ю́|Я́|ё́|Ё́)","i","Найдено: русские буквы с ударением.");
  
  addRegExp("[^\\u0400-\\u04FF\\u0020-\\u007F\\u0100-\\u017F\\u0180-\\u024F\\u00A0-\\u00FF\\u0370-\\u03FF\\u2200-\\u22FF\\u2150-\\u218F\\x20\\xA0\\t\\n\\r\\f„“–\…—­№✓♦•-]","","Найдено: Странные нетекстовые символы");

  addRegExp("([аеёиоуыэюя]2[а-я])","i","Найдено: вероятно, гласная буква с ударением.");
  
   addRegExp("([аеёиоуыэюя]')","i","Найдено: вероятно, 'неправильное' ударение 'первого' типа.");
   addRegExp("('[аеёиоуыэюя])","i","Найдено: вероятно, 'неправильное' ударение 'второго' типа.");




// -------------конец блока TaKir - регэкспы (25.10.2025):---------------
