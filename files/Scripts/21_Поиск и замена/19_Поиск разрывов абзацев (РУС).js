...
// -------------начало блока TaKir - регэкспы (TaKir, 16.05.2024)---------------

    
tagRegExp("(?<=<мы-не-внутри-тэга>)([^\»….,:;!\?]|[—–,-])<впереди-закр-тэги-но-не-A>$","","Найдено: концы строк без точек","-title -subtitle -stanza -poem -epigraph");
  tagRegExp("(?<=<мы-не-внутри-тэга>)(?<!(^|[^а-яёА-ЯЁ])<сокращения>)<тэги-кроме-IMG-и-закр-A>[.\\]!\?]<тэги-кроме-IMG-и-закр-A>([\\x20\\xA0\\t\\n\\r\\f]+<тэги-кроме-IMG-и-закр-A>)*[а-яё]<тэги-кроме-IMG-и-закр-A>(?!\\.)<впереди-нет-закр-A>","","Найдено: маленькая буква вместо заглавной после знаков препинания");
  ...
  addRegExp("^[…][\\x20\\xA0\\t\\n\\r\\f][A-Za-zА-яЁё]","i","Найдено: многоточие и пробел в начале абзаца");



// -------------конец блока TaKir - регэкспы (TaKir, 16.05.2024)---------------
