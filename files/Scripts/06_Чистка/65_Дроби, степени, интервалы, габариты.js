//=========================================
//     «Дроби, степени, интервалы, габариты» v.1.01 (март 2024)
...
var re50 = new RegExp("^(.*?(?:"+nbspEntity+"| )){0,1}([ксм]?м)([23])(.*?){0,1}$","gi");
 ...
 var re54 = "$2<sup>$3</sup>";                                            // предлагаемый вариант в запросе
  ...
  // габариты-объём:
var re40a = new RegExp("^(.*?[^\\\d]){0,1}(\\\d+)((?:"+nbspEntity+"| ){0,1}[xх](?:"+nbspEntity+"| ){0,1})(\\\d+)((?:"+nbspEntity+"| ){0,1}[xх](?:"+nbspEntity+"| ){0,1})(\\\d+)([^\\\d].*?){0,1}$","gi");
 var re41a = "$2$3$4$5$6";
 var re42a = "$1";
 var re43a = "$7";
 var re44a = "$2×$4×$6";
 ...
 // габариты-площадь:
var re40 = new RegExp("^(.*?[^\\\d]){0,1}(\\\d+)((?:"+nbspEntity+"| ){0,1}[xх](?:"+nbspEntity+"| ){0,1})(\\\d+)([^\\\d].*?){0,1}$","gi");
 var re41 = "$2$3$4";
 var re42 = "$1";
 var re43 = "$5";
 var re44 = "$2×$4";
 ...
 var re30 = new RegExp("^(.*?[^\\\d]){0,1}(1/4)([^\\\d].*?){0,1}$","gi");
 var re31 = "$2";
 var re32 = "$1";
 var re33 = "$3";
 var re34 = "¼";

 var re30a = new RegExp("^(.*?[^\\\d]){0,1}(1/2)([^\\\d].*?){0,1}$","gi");
 var re31a = "$2";
 var re32a = "$1";
 var re33a = "$3";
 var re34a = "½";

 var re30b = new RegExp("^(.*?[^\\\d]){0,1}(3/4)([^\\\d].*?){0,1}$","gi");
 var re31b = "$2";
 var re32b = "$1";
 var re33b = "$3";
 var re34b = "¾";

 var re30c = new RegExp("^(.*?[^\\\d]){0,1}(1/3)([^\\\d].*?){0,1}$","gi");
 var re31c = "$2";
 var re32c = "$1";
 var re33c = "$3";
 var re34c = "⅓";
 
  var re30d = new RegExp("^(.*?[^\\\d]){0,1}(2/3)([^\\\d].*?){0,1}$","gi");
 var re31d = "$2";
 var re32d = "$1";
 var re33d = "$3";
 var re34d = "⅔";

 var re30e = new RegExp("^(.*?[^\\\d]){0,1}(1/5)([^\\\d].*?){0,1}$","gi");
 var re31e = "$2";
 var re32e = "$1";
 var re33e = "$3";
 var re34e = "⅕";

 var re30f = new RegExp("^(.*?[^\\\d]){0,1}(2/5)([^\\\d].*?){0,1}$","gi");
 var re31f = "$2";
 var re32f = "$1";
 var re33f = "$3";
 var re34f = "⅖";

 var re30g = new RegExp("^(.*?[^\\\d]){0,1}(3/5)([^\\\d].*?){0,1}$","gi");
 var re31g = "$2";
 var re32g = "$1";
 var re33g = "$3";
 var re34g = "⅗";

 var re30h = new RegExp("^(.*?[^\\\d]){0,1}(4/5)([^\\\d].*?){0,1}$","gi");
 var re31h = "$2";
 var re32h = "$1";
 var re33h = "$3";
 var re34h = "⅘";
 
  var re30i = new RegExp("^(.*?[^\\\d]){0,1}(1/6)([^\\\d].*?){0,1}$","gi");
 var re31i = "$2";
 var re32i = "$1";
 var re33i = "$3";
 var re34i = "⅙";

 var re30j = new RegExp("^(.*?[^\\\d]){0,1}(5/6)([^\\\d].*?){0,1}$","gi");
 var re31j = "$2";
 var re32j = "$1";
 var re33j = "$3";
 var re34j = "⅚";

 var re30k = new RegExp("^(.*?[^\\\d]){0,1}(1/8)([^\\\d].*?){0,1}$","gi");
 var re31k = "$2";
 var re32k = "$1";
 var re33k = "$3";
 var re34k = "⅛";

 var re30l = new RegExp("^(.*?[^\\\d]){0,1}(3/8)([^\\\d].*?){0,1}$","gi");
 var re31l = "$2";
 var re32l = "$1";
 var re33l = "$3";
 var re34l = "⅜";

 var re30m = new RegExp("^(.*?[^\\\d]){0,1}(5/8)([^\\\d].*?){0,1}$","gi");
 var re31m = "$2";
 var re32m = "$1";
 var re33m = "$3";
 var re34m = "⅝";
 
  var re30n = new RegExp("^(.*?[^\\\d]){0,1}(7/8)([^\\\d].*?){0,1}$","gi");
 var re31n = "$2";
 var re32n = "$1";
 var re33n = "$3";
 var re34n = "⅞";
 ...
 var re70 = new RegExp("^(.*?){0,1}(\\\d+)((?:"+nbspEntity+"| )?-(?:"+nbspEntity+"| )?)(\\\d+)(.*?){0,1}$","gi");
 var re71 = "$2$3$4";
 var re72 = "$1";
 var re73 = "$5";
 var re74 = "$2–$4";

 var re80 = new RegExp("^(.*?){0,1}(\\\d+)((?:"+nbspEntity+"| )?—(?:"+nbspEntity+"| )?)(\\\d+)(.*?){0,1}$","gi");
 var re81 = "$2$3$4";
 var re82 = "$1";
 var re83 = "$5";
 var re84 = "$2–$4";

 var re90 = new RegExp("^(.*?){0,1}(\\\d+)((?:"+nbspEntity+"| )–|–(?:"+nbspEntity+"| )|(?:"+nbspEntity+"| )–(?:"+nbspEntity+"| ))(\\\d+)(.*?){0,1}$","gi");
 var re91 = "$2$3$4";
 var re92 = "$1";
 var re93 = "$5";
 var re94 = "$2–$4";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------
 // вариант с выделением всех\й строк\и(?) в интервалах чисел со степенями, если в строке их несколько:
...
/*  var re70s = new RegExp("^(.*?[^\\\d]){0,1}(\\\d+)("+stepen+")((?:"+nbspEntity+"| )?-(?:"+nbspEntity+"| )?)(\\\d+)([^\\\d].*?){0,1}$","gi");
 ...
 // ================================================================================
 //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
 // вариант выделения только одного тире-дефиса вместе с пробелами в интервалах чисел со степенями:
