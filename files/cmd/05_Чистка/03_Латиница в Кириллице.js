...
// Попытка поймать однобуквенные предлоги, но только строчные — прописные могут быть и обозначениями переменных, хотя и со строчными всяко может быть…
 ...
 var re7a = new RegExp("([А-яЁё]{2,})([»\\\"“]{0,1})(\\\s|&nbsp;)(a)(\\\s|&nbsp;)([«\\\"„]{0,1})([А-яЁё]{2,})","g");             //   a -> а
 var re7a_ = "$1$2 а $6$7";

 var re7c = new RegExp("([А-яЁё]{2,})([»\\\"“]{0,1})(\\\s|&nbsp;)(c)(\\\s|&nbsp;)([«\\\"„]{0,1})([А-яЁё]{2,})","g");             //   c -> с
 var re7c_ = "$1$2 с $6$7";

 var re7o = new RegExp("([А-яЁё]{2,})([»\\\"“]{0,1})(\\\s|&nbsp;)(o)(\\\s|&nbsp;)([«\\\"„]{0,1})([А-яЁё]{2,})","g");             //   o -> о
 var re7o_ = "$1$2 о $6$7";

 var re7y = new RegExp("([А-яЁё]{2,})([»\\\"“]{0,1})(\\\s|&nbsp;)(y)(\\\s|&nbsp;)([«\\\"„]{0,1})([А-яЁё]{2,})","g");             //   y -> у
 var re7y_ = "$1$2 у $6$7";
