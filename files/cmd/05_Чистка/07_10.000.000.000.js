...
var re50 = new RegExp("^(.*?[^\\\d\\\-N№/]){0,1}(\\\d{1,3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([^\\\d/].*?){0,1}$","gi");
 ...
 var re54 = "$2 $4 $6 $8 $10 $12";                                            // предлагаемый вариант в запросе
...
var re40 = new RegExp("^(.*?[^\\\d\\\-N№/]){0,1}(\\\d{1,3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([\\\s\\\.]{0,2})(\\\d{3})([^\\\d/].*?){0,1}$","gi");
 ...
 var re60 = new RegExp("^(.*?[^\\\d\\\-N№/]){0,1}([1-9])(&nbsp;)(\\\d{3})([^\\\d(&nbsp;)].*?){0,1}$","gi");
 var re61 = "$2 $4";
 var re62 = "$1";
 var re63 = "$5";
 var re64 = "$2$4";
...
//    window.external.BeginUndoUnit(document,"«большие» числа");                               // отключил откат — жрёт оперативку
