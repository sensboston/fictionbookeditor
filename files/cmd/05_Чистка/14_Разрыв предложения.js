...
//~~~~~~~~~~~~
// v.1.5 — баловство со статистикий (14.04.2008)
//======================================
...
function Run()
{
 ...
 var re0 = new RegExp("([^!…\\\?_][a-z0-9а-яё](</EM>|</STRONG>|</EM></STRONG>|</STRONG></EM>){0,1})(\\\s|&nbsp;){0,}</P>\\\r\\\n<P>(\\\s|&nbsp;){0,}((<EM>|<STRONG>|<EM><STRONG>|<STRONG><EM>){0,1}[«\\\"\\\-]{0,1}(\\\s|&nbsp;){0,}[a-zа-яё]{1,}[^\\\)])","gm");
 ...
 var re1 = new RegExp("([^!…\\\?_][a-z0-9А-яё,;—–\\\-\\\»\\\)IVX](</EM>|</STRONG>|</EM></STRONG>|</STRONG></EM>){0,1})(\\\s|&nbsp;){0,}</P>\\\r\\\n<P>(\\\s|&nbsp;){0,}((<EM>|<STRONG>|<EM><STRONG>|<STRONG><EM>){0,1}[«\\\(\\\[\\\"\\\-–—=]{0,1}(\\\s|&nbsp;){0,}[a-z0-9а-яё\\\?\\\!…\\\"]+[^\\\)])","gm");
 ...
 var re2 = new RegExp("([a-zа-яё\\\d\\\w][\\\?!…»\\\"“](</EM>|</STRONG>|</EM></STRONG>|</STRONG></EM>){0,1})(\\\s|&nbsp;){0,}</P>\\\r\\\n<P>(\\\s|&nbsp;){0,}((<EM>|<STRONG>|<EM><STRONG>|<STRONG><EM>){0,1}[«\\\"\\\(\\\[\\\-–—\\\.,<]{0,1}(\\\s|&nbsp;){0,}(\\\s|&nbsp;){0,1}[a-zа-яё…\\\"«][a-zа-яё\\\d])","gm");
...
// variant N°0                                         // автомат — бесспорные замены
 var m0 = ss.search(re0);                       // search - позиция совпадения от начала строки, нет совпадения: search=-1
					...
					{ GoTo(ps[j]);                    // смещение фокуса на искомый параграф
