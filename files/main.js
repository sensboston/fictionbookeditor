...
{  
  ...
  var baseWidth = winWidth - coordX;
  if(2*coordX - winWidth < 0)
    baseWidth =  coordX;
    
  baseWidth = baseWidth*2 - 20;
  var baseHeight = coordY - 20;
  ...
  prevImgPanel.style.top = (coordY + scrollY - Math.round(imgHeight) - 20) + "px";
...
function TransformXML(xslt, dom)
{
	...
	proc.transform(); body.innerHTML=proc.output;
