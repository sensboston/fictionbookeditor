...
public:
	...
	HRESULT Save( LPCTSTR pszFileName, REFGUID guidFileType = GUID_NULL, Gdiplus::EncoderParameters* encoderParameters = NULL ) const throw();
...
inline HRESULT CImage::Save( LPCTSTR pszFileName, REFGUID guidFileType, Gdiplus::EncoderParameters* encoderParameters) const throw()
{
	if( !InitGDIPlus() )
	{
		return( E_FAIL );
