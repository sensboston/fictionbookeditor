...
// замена неразрывных пробелов на обычные
 var re01 = new RegExp("([А-Яа-яa-zё—]("+aIB+"){0,1}[\\\?!\\\.,:]{0,1})&nbsp;(("+sIB+"){0,1}[а-яa-zё])([^\\\.])","g");
 var re01_ = "$1 $3$5";
 var count_01 = 0;
...
// лидирующее тире с неразрывным пробелом в диалогах; удаление случайного мусора после скана: точка в начале диалога
 var re08 = new RegExp("^("+sIB+"){0,1}([«\\\"]){0,1}[-–—~]{1,2}("+sIB+"){0,1}(\\\s|&nbsp;){0,1}\\\.{0,1}("+sIB+"){0,1}([\\\wА-яЁё«\\\"„\\\(\\\?!…])","gi");
 var re08_ = "$1$2— $3$5$6";
 var count_08 = 0;

// нормализация одиночных курсивных знаков препинания
 var re09 = new RegExp("("+sIB+")([\\\s,\\\.\\\-–—;!\\\?:/~])(\\\s|&nbsp;){0,1}("+fIB+")","gi");
 var re09_ = "$2$3";
 var count_09 = 0;

// денормализация одиночных знаков препинания
 var re09a = new RegExp("("+sIB+")((\\\s|&nbsp;){0,1}[\\\s\\\-–—](\\\s|&nbsp;){0,1})("+fIB+")","gi");
 var re09a_ = "$2";
 var count_09 = 0;

// удаление стыков эмфазиса и стронга
 var re10 = new RegExp("</EM>(\\\s|&nbsp;){0,1}<EM>|</STRONG>(\\\s|&nbsp;){0,1}<STRONG>","gi");
 var re10_ = "$1";
 var count_10 = 0;
...
// тире после препинаний
 var re13 = new RegExp("([a-zа-яё\\\"“»\\\)\\\? ])(\\\s|&nbsp;){0,1}("+aIB+"){0,1}([,!\\\?…])(\\\s|&nbsp;){0,1}("+aIB+"){0,1}-{1,2}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+sIB+"){0,1}(.[^.])","gi");
 var re13_ = "$1$4$3$6 — $7$9$10";
 var count_13 = 0;

// тире после препинаний — (!..) и (?..)
 var re13a = new RegExp("([!\\\?]\\\.\\\.)("+aIB+"){0,1}(\\\s|&nbsp;){0,1}([\\\-–—]){1,2}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+aIB+"){0,1}(.[^.])","gi");
 var re13a_ = "$1$2$5 — $7$8";

// тире после препинаний /!).-/
 var re13b = new RegExp("([!\\\?]\\\")("+aIB+"){0,1}(\\\s|&nbsp;){0,1}([\\\-–—]){1,2}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+aIB+"){0,1}(.[^.])","gi");
 var re13b_ = "$1$2$5 — $7$8";


// тире после препинаний
 var re13c = new RegExp("([!\\\?\\\)])("+aIB+"){0,1}(\\\s|&nbsp;){0,1}([\\\-–—]){1,2}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+aIB+"){0,1}([А-яё])","gi");
 var re13c_ = "$1$2$5 — $7$8";

// замена дефисов на тире не после препинаний
 var re14 = new RegExp("([^\\\.,!\\\?…])(\\\s|&nbsp;)("+aIB+"){0,1}[-–]{1,2}(\\\s|&nbsp;){0,1}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}([^\\\d<])","gi");
 var re14_ = "$1$3 — $5$7";
 var count_14 = 0;

// замена дефисов на тире "A": после !..-, с пробелом или без
 var re14a = new RegExp("(!\\\.\\\.)("+aIB+"){0,1}(\\\s|&nbsp;){0,1}[-–]{1,2}("+aIB+"){0,1}("+sIB+"){0,1}(\\\s|&nbsp;){0,1}("+sIB+"){0,1}([^\\\d<])","gi");
 var re14a_ = "$1$2$4 — $5$7$8";

// замена дефисов на тире "Б": после букв и точки, с пробелом
 var re14b = new RegExp("([а-яё])(\\\.)("+aIB+"){0,1}(\\\s|&nbsp;)[-–]{1,2}("+aIB+"){0,1}("+sIB+"){0,1}(\\\s|&nbsp;){0,1}("+sIB+"){0,1}([^\\\d<])","g");
 var re14b_ = "$1$2$3 — $5$6$8$9";


// замена дефисов на тире "В": после букв и точки перед буквой без точки
 var re14c = new RegExp("([а-яё])(\\\.)("+aIB+"){0,1}[-–]{1,2}("+aIB+"){0,1}("+sIB+"){0,1}(\\\s|&nbsp;){0,1}("+sIB+"){0,1}([А-яЁё][^\\\.])","g");
 var re14c_ = "$1$2$3 — $4$5$7$8";

// кавычки одиночного символа или небольшого слова
 var re15 = new RegExp("(\\\s|&nbsp;)\\\"(\\\s|&nbsp;){0,1}([\\\w0-9А-яЁё\\\-]{1,20})(\\\s|&nbsp;){0,1}\\\"([\\\.,:;\\\?!…]){0,1}(\\\s|&nbsp;)","gi");
 var re15_ = "$1«$3»$5$6";
...
// попытка вернуть кавычки на место, после пробела
 var re17 = new RegExp("\\\"([\\\w0-9А-яЁё\\\-]{1,20})([^:])(\\\s|&nbsp;)\\\"(\\\s|&nbsp;)","gi");
 var re17_ = "«$1$2»$4";

// замыкающие кавычки в конце строки после пробела
 var re18 = new RegExp("(\\\s|&nbsp;)\\\"$","gi");
 var re18_ = "»";

// замена конечных дефисов на тире !!!Только в стихах!!!
 var re19 = new RegExp("(\\\s|&nbsp;){0,1}([\\\-–]){1,2}(\\\s|&nbsp;){0,1}(</((EM)|(STRONG))>){0,1}$","gi");
 var re19_ = " —$4";


// удаление сдвоенных тире
 var re20 = new RegExp("([\\\-–—])(\\\s|&nbsp;){0,1}([\\\-–—])","gi");
 var re20_ = "$1";
...
// апостроф (или как его там) не там, где надо
 var re22 = new RegExp("([^a-zа-яё])'([^a-zа-яё])","gi");
 var re22_ = "$1 $2";

// то же, но в конце строки
 var re23 = new RegExp("([^a-zа-яё])'$","gi");
 var re23_ = "$1";
...
// пропущенный пробел перед тире после букв
 var re26 = new RegExp("([A-zА-яЁё\\\)»:])("+fIB+"){0,1}:("+aIB+"){0,1}—(\\\s|&nbsp;){0,1}","gi");
 var re26_ = "$1$2 — ";
 var count_26 = 0;
...
// точка в начале строки
 var re28 = new RegExp("^\\\.(\\\s|&nbsp;){0,1}([\\\wА-яЁё«\\\"„\\\(\\\?!…])","gi");
 var re28_ = "$2";

// тире вместо дефиса после точки перед Прописной
 var re29 = new RegExp("(\\\.)("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+aIB+"){0,1}\\\-("+aIB+"){0,1}(\\\s|&nbsp;)("+sIB+"){0,1}([«„\\\"“]{0,1}[А-ЯЁ])","g");
 var re29_ = "$1$2$4 — $5$7$8";
 var count_29 = 0;


// удаление точки/запятой после запятой/точки между строчными
 var re31= new RegExp("([А-яЁё»\\\)])("+aIB+"){0,1}([,\\\.])("+aIB+"){0,1}([\\\.,]){0,1}([a-zа-яё][^\\\.])","g");
 var re31_ = "$1$2$4$3 $6";

// удаление точки/запятой после запятой/точки между строчными
 var re31a= new RegExp("([а-яё»\\\)])("+aIB+"){0,1}([,\\\.])("+aIB+"){0,1}([\\\.,]){0,1}([A-zА-яЁё][^\\\.])","g");
...
// квадратное окавычивание порядкового номера в ссылке сноски
 var re40 = new RegExp("(<A class=note href=\\\"[^>]+\\\d{1,4}\\\">)[\\\[{]{0,1}[a-zа-я_\\\-]{0,10}(\\\s|&nbsp;){0,1}(\\\d{1,4})[\\\]}]{0,1}(</A>)","gi");
 var re40_ = "$1[$3]$4";
...
// снятие курсива со сноски
 var re42 = new RegExp("("+sIB+")([\\\.\\\s]{0,1}<A class=note href=\\\"[^>]+\\\d{1,4}\\\">[^><]+?</A>)","gi");
 var re42_ = "$2$1";

// удаление пробела после [сноски] , если за пробелом следует препинание
 var re43 = new RegExp("(<A class=note href=\\\"[^>]+\\\d{1,4}\\\">[^><]+?</A>)(\\\s|&nbsp;)([\\\.,!\\\?:\\\;])(\\\s|&nbsp;)","gi");
 var re43_ = "$1$3$4";

// удаление пробела перед [сноской]
 var re44 = new RegExp("(\\\s|&nbsp;){0,1}("+aIB+"){0,1}(\\\s|&nbsp;){0,1}(<A class=note href=\\\"[^>]+\\\d{1,4}\\\">[^><]+?</A>)","gi");
 var re44_ = "$2$4";

// удаление одного пробела вокруг </emphasis'а>
 var re45 = new RegExp("(\\\s|&nbsp;)("+aIB+")(\\\s|&nbsp;)","gi");
 var re45_ = "$1$2";

// препинания после [сноски] {в конце строки} везде
 var re46 = new RegExp("(<A class=note href=\\\"[^>]+\\\d{1,4}\\\">[^><]+?</A>)([\\\.!\\\?,:;]+("+fIB+"){0,1})","gi");
 var re46_ = "$2$1";
...
// вставка пробела после [сноски] —
 var re47 = new RegExp("(<A class=note href=\\\"[^>]+\\\d{1,4}\\\">[^><]+?</A>)("+sIB+"){0,1}([А-яЁёA-z\\\-–—\\\(\\\[])","gi");
 var re47_ = "$1 $2$3";
 var count_47 = 0;

 // удаление одного пробела вокруг <emphasis'а>
 var re48 = new RegExp("(\\\s|&nbsp;)("+sIB+")(\\\s|&nbsp;)","gi");
 var re48_ = "$2$3";
...
// пронумерованный список: Ст. 15
 var re50a = new RegExp("^(("+sIB+"){0,1}([«\\\"]){0,1}(Ст)\\\.)(\\\s|&nbsp;){0,1}(\\\d{1,4})\\\.\\\s","g");
 var re50a_ = "$1 $6. ";
...
// перечень страниц и т.п. через запятую
 var re51 = new RegExp("(с|р|т|v|p)\\\.(\\\s|&nbsp;){0,1}(\\\d{1,4}),(\\\d{1,4})","gi");
 var re51_ = "$1. $3, $4";
 var count_51 = 0;

// перечень страниц и т.п. с интевалом
 var re52 = new RegExp(" (с|р|т|v|p)\\\.(\\\s|&nbsp;){0,1}(\\\d{1,4})-(\\\d{1,4})","gi");
 var re52_ = " $1. $3–$4";
...
// var re54_ = "$1 $2";                                                 // "правильный" узкий пробел, отображется малым кол-вом шрифтов
 var re54_ = "$1 $2";                                                     // неразрывный пробел

// длинное тире после препинаний
 var re55 = new RegExp("([a-zа-яё\\\"“»\\\)\\\? ])("+aIB+"){0,1}([,!\\\?…\\\.\\\"]+)("+aIB+"){0,1}\\\s{0,1}—{1,2}(\\\s|&nbsp;){0,1}(.[^.])","gi");
 var re55_ = "$1$2$3$4 — $6";
 var count_55 = 0;

// длинное тире после препинаний и неразрывного пробела
 var re55a = new RegExp("([a-zа-яё\\\"“»\\\)\\\? ])("+aIB+"){0,1}([,!\\\?…\\\.]+)("+aIB+"){0,1}(&nbsp;)—{1,2}(.[^.])","gi");
 var re55a_ = "$1$2$3$4 — $6";

// длинное тире после букв и неразрывного пробела
 var re55b = new RegExp("([a-zа-яё\\\"“»])("+aIB+"){0,1}(&nbsp;)—{1,2}(.[^.])","gi");
 var re55b_ = "$1$2 — $4";

// удаление стыков эмфазиса
 var re56 = new RegExp("</EM>((\\\s|&nbsp;){0,1}[–—\\\.,;:!\\\?]{0,1}(\\\s|&nbsp;){0,1})<EM>","gi");
 var re56_ = "$1";

// тире вместо дефиса после точки перед открывающимися угловыми кавычками
 var re57 = new RegExp("(\\\.)(\\\s|&nbsp;){0,1}\\\-("+aIB+"){0,1}(\\\s|&nbsp;){0,1}("+sIB+"){0,1}([«„\\\"])","g");
 var re57_ = "$1$3 — $5$6";

// пропущенный пробел после тире после букв и перед буквами
 var re58 = new RegExp("([A-zА-яЁё\\\)\\\"»])("+fIB+"){0,1}(\\\s|&nbsp;)("+fIB+"){0,1}—("+fIB+"){0,1}("+sIB+"){0,1}([A-zА-яЁё\\\(«])","gi");
 var re58_ = "$1$2$4 — $5$6$7";


//  последовательность чисел
// var re54 = new RegExp("(\\\d),(\\\s|&nbsp;){0,1}(\\\d+),(\\\s|&nbsp;){0,1}(\\\d+),(\\\s|&nbsp;){0,1}(\\\d)","gi");
// var re54_ = "$1, $3, $5, $7";



// интервал дат !!! Остались стрёмные моменты с длинным набором чисел, вроде почтового индекса или серийного номера
 var re60 = new RegExp("([^\\\-0-9№N\\\wА-я\\\)\\\/])(\\\d{4})(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d{4})([^a-zа-я0-9\\\-])","gi");
 var re60_ = "$1$2–$5$6";
// var count_60 = 0;

// интервал дат в отдельной строке
 var re60a = new RegExp("^(\\\d{4})(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d{4})","gi");
 var re60a_ = "$1–$4";

// интервал дат в начале абзаца
 var re61 = new RegExp("^(\\\d{4})(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d{4})([^a-zа-я0-9\\\-])","gi");
 var re61_ = "$1–$4$5";

// интервал дат
 var re62 = new RegExp("([^\\\-0-9№N\\\wА-я\\\)\\\/])(\\\d{3})(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d{3})([^a-zа-я0-9\\\-])","gi");
 var re62_ = "$1$2–$5$6"; 

// интервал дат
 var re63 = new RegExp("([^\\\-0-9№N\\\wА-я\\\)\\\/])(\\\d{2})(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d{2})([^a-zа-я0-9\\\-])","gi");
 var re63_ = "$1$2–$5$6"; 

// интервал дат
 var re64 = new RegExp("([^\\\-0-9№N\\\wА-я\\\)\\\/])(\\\d)(\\\s|&nbsp;){0,1}[-–—]{1,2}(\\\s|&nbsp;){0,1}(\\\d)([^a-zа-я0-9\\\-])","gi");
 var re64_ = "$1$2–$5$6"; 
...
//  знак K°
 var re66 = new RegExp("([и&])(\\\s|&nbsp;){0,1}([KК])([oо°])([^A-zА-яЁё])","g");
 var re66_ = "$1 K°$5";

//  градус Цельсия
 var re67 = new RegExp("(\\\d)(\\\s|&nbsp;){0,1}[oо0°](\\\s){0,1}[CС]([^A-zА-яЁё]){0,1}","g");
 var re67_ = "$1 °C$4";

//  даты по-римски
 var re68 = new RegExp("([IVXLC])(\\\s|&nbsp;){0,1}[\\\-–—](\\\s|&nbsp;){0,1}([IVXLC])","g");
 var re68_ = "$1–$4";

//  знак №
 var re69 = new RegExp("N[oо°](\\\s|&nbsp;){0,1}(\\\d+)","g");
 var re69_ = "№ $2";
...
//  десятичные дроби
// Пришлось отключить, иногда принимаются за десятичную дробь выражения типа: 1800, 2100 и 3500 футов
// var re69 = new RegExp("([^\\\d])([^,])(\\\s|&nbsp;)(\\\d+),(\\\s| |&nbsp;)(\\\d+)(\\\s| |&nbsp;)([^,])([^\\\d])","gi");
// var re69_ = "$1$2$3$4,$6$7$8$9";
...
// удаление конечных пробелов строки
 var re81 = new RegExp("(\\\s|&nbsp;)+("+aIB+"){0,1}$","gi");
 var re81_ = "";
 var count_81 = 0;

// удаление начальных пробелов строки
 var re82 = new RegExp("^("+sIB+"){0,1}(\\\s|&nbsp;)+","gi");
 var re82_ = "$1";
 var count_82 = 0;
...
//    window.external.BeginUndoUnit(document,"«генеральная уборка»");                               // отключил откат — жрёт оперативку
 ...
 function HandleP(ptr) {
  ...
  //   if (s.search(re87)!=-1)         { s=s.replace(re87, re87_); }
       ...
       if (s.search(re40)!=-1)         { s=s.replace(re40, re40_); }
       if (s.search(re41)!=-1)         { s=s.replace(re41, re41_); }
       if (s.search(re42)!=-1)         { s=s.replace(re42, re42_); }
       if (s.search(re43)!=-1)         { s=s.replace(re43, re43_); }
       if (s.search(re44)!=-1)         { s=s.replace(re44, re44_); }
       if (s.search(re45)!=-1)         { s=s.replace(re45, re45_); }
       if (s.search(re46)!=-1)         { s=s.replace(re46, re46_); }
       if (s.search(re46a)!=-1)       { s=s.replace(re46a, re46a_); }
       ...
       if (s.search(re80)!=-1)         { s=s.replace(re80, re80_);}
       ...
       if (s.search(re84)!=-1 && ptr.parentNode.className=="title")         { s=s.replace(re84, re84_); count_84++}
       ...
       if (s.search(re92)!=-1)         { s=s.replace(re92, re92_); }
