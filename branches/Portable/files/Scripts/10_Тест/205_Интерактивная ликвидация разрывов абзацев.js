...
function Run() {
 ...
 var coll=new Object();
 var modes=window.showModalDialog("Scripts/интеракт. удаление разрывов - выбор режимов.htm",coll,
 ...
 if (handHandle) {
  ...
  coll["window"]=window;
  var rslt=window.showModalDialog("Scripts/интеракт. удаление разрывов - спорные места.htm",coll,
       "dialogHeight: "+dialogHeight+"; dialogWidth: "+dialogWidth+"; "+
