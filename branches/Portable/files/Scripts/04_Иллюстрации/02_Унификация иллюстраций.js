// Унификация вложений и картинок   13 сентября 2007 г.
...
function Run() {
 ...
 window.external.BeginUndoUnit(document,"унификация иллюстраций");
 ...
 for (i=0;i<bins.length;i++) {
  ...
  else { MsgBox('	–= Sclex Script =– \n\n'+
         'ОШИБКА.\n'+
         'Два вложения имеют одинаковый id: '+id); return; }
 }
 var href;
 ...
 if (id!='' && id==id_) {
  MsgBox('	–= Sclex Script =– \n\n'+
         'ОШИБКА.\n'+
         'Обложка книги и обложка оригинального издания\n'+
         '       ссылаются на одно и то же вложение.\n'+
 ...
 if (NonJpegPngImgs_list!="") {st2+='\nВложения не image/jpg; image/png:	 '+NonJpegPngImgs_list;}
 if (st2!="") st2="\n"+st2;
 MsgBox('	–= Sclex Script =– \n'+
    ' «Унификация вложений и картинок» v.'+VersionNumber+' \n\n'+
        ...
        '    Ошибка формата рисунка:	'+NonJpegPngImgs["0"]+'\n\n'+
