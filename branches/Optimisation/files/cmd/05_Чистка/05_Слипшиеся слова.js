...
// var re70 = new RegExp("^(.*?){0,1}([^;][а-яё]+\\\){0,1})(([:,])|( {0,1}[–—\\\-])|([–—\\\-] {0,1})){0,1}(\\\d+)(.*?){0,1}$","g"); // и почему это я был против неразрывного пробела перед буквой - не помню. ((
 ...
 var re90 = new RegExp("^(.*?){0,1}([а-яёa-z\\\"“»%]+)("+fIB+"){0,1}([\\\.,])((\\\s)|(&nbsp;)){0,1}([\\\-–])(\\\s|&nbsp;)("+sIB+"){0,1}([а-яё]+)(.+){0,1}$","gi");
 ...
 var re12as = "$2$3$4";
                                                       ...
                                                       // Разнообразный мусор.
 var re130 = new RegExp("^(.*?){0,1}([а-яё\\\.;:,!\\\?—]+)((\\\s)|(&nbsp;)){0,1}([\\\<\\\>•■~])((\\\s)|(&nbsp;)){0,1}([а-яё—–«»„“]+)(.*?){0,1}$","gi");
 ...
 var re190 = new RegExp("^(("+sIB+").+?)("+fIB+")([A-zА-яЁё\\\d, –—\\\-\\\&nbsp;]{1,11})("+sIB+")(.+?("+fIB+"))$","gi");
 var re191 = "$3$4$5";
 var re192 = "$1";
 var re193 = "$6";
 var re194 = "$4";
