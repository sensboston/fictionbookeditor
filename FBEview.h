...
public:
  ...
  BEGIN_MSG_MAP(CFBEView)
	...
	COMMAND_ID_HANDLER_EX(ID_ADD_DATE, OnEditInsertDate)
  ...
  LRESULT OnEditInsertDate(WORD wNotifyCode, WORD wID, HWND hWndCtl){Call(L"AddDate",SelectionStructCon()); return 0; };
