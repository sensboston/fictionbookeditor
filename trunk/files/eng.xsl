...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="IDS_VIEW_BTN" select="'View'"/>
  <xsl:variable name="IDS_BINARY_OBJ" select="'Binary Objects'"/>
  <xsl:variable name="IDS_BOOK" select="'Book'"/>
  <xsl:variable name="IDS_GENRES" select="'Genres'"/>
  <xsl:variable name="IDS_GENRE" select="'Genre:'"/>
  <xsl:variable name="IDS_MATCH" select="'Match (%):'"/>
  <xsl:variable name="IDS_AUTHORS" select="'Authors'"/>
  <xsl:variable name="IDS_TITLE" select="'Title:'"/>
  <xsl:variable name="IDS_KEYWORDS" select="'Keywords:'"/>
  <xsl:variable name="IDS_DATE_TEXT" select="'Date text:'"/>
  <xsl:variable name="IDS_DATE_VALUE" select="'Date value:'"/>
  <xsl:variable name="IDS_COVERPAGE" select="'Coverpage'"/>
  <xsl:variable name="IDS_IMAGE" select="'Image:'"/>
  <xsl:variable name="IDS_LANGUAGE" select="'Language:'"/>
  <xsl:variable name="IDS_SOURCE_LANG" select="'Source language:'"/>
  <xsl:variable name="IDS_TRANSLATORS" select="'Translators'"/>
  <xsl:variable name="IDS_SEQUENCE" select="'Sequence'"/>
  <xsl:variable name="IDS_STI" select="'Source Title Info'"/>
  <xsl:variable name="IDS_DOCUMENT" select="'FB2 Document'"/>
  <xsl:variable name="IDS_VERSION" select="'Version:'"/>
  <xsl:variable name="IDS_NEW" select="'new'"/>
  <xsl:variable name="IDS_ID" select="'ID:'"/>
  <xsl:variable name="IDS_TOOLS_USED" select="'Tools used:'"/>
  <xsl:variable name="IDS_SOURCE_OCR" select="'Source OCR:'"/>
  <xsl:variable name="IDS_SOURCE_URL" select="'Source URLs'"/>
  <xsl:variable name="IDS_PAPER_BOOK" select="'Paper Book'"/>
  <xsl:variable name="IDS_BOOK_TITLE" select="'Book title:'"/>
  <xsl:variable name="IDS_PUBLISHER" select="'Publisher:'"/>
  <xsl:variable name="IDS_CITY" select="'City:'"/>
  <xsl:variable name="IDS_YEAR" select="'Year:'"/>
  <xsl:variable name="IDS_ISBN" select="'ISBN:'"/>	
  <xsl:variable name="IDS_CUSTOM_INFO" select="'Custom Info'"/>
  <xsl:variable name="IDS_TYPE" select="'Type:'"/>
  <xsl:variable name="IDS_VALUE" select="'Value:'"/>
  <xsl:variable name="IDS_FIRST" select="'First:'"/>
  <xsl:variable name="IDS_MIDLE" select="'Middle:'"/>
  <xsl:variable name="IDS_LAST" select="'Last:'"/>
  <xsl:variable name="IDS_NICKNAME" select="'Nickname:'"/>
