...
void CSettings::Load()
{
	...
	m_insimage_ask			= U::QueryIV(m_key, INSIMAGE_ASKING, true);
	m_script_hotkey_err		= U::QueryIV(m_key, SCRIPTS_HKEY_ERR_NTF, true);
	m_ins_clear_image		= U::QueryIV(m_key, INS_CLEAR_IMAGE, false);
}
